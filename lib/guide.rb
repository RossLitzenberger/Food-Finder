...
class Guide
	...
	def get_action
		action = nil
		# Keep asking for user input until we get a vaild action
	...
	def list
		out_action_header("Listing restaurant")
		restaurants = Restaurant.saved_restaurants
		output_restaurant_table(restaurants)
	end
	def find(keyword="")
		out_action_header("Find a restaurant")
		if keyword
	...
	def add
		out_action_header("Add a restaurant")
